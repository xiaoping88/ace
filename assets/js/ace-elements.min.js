...
(function(a, b) {
	function SideBar(c, e) {
		...
		this.settings = a.extend({}, a.fn.ace_sidebar.defaults, e, h);
		this.minimized = !1;
		this.collapsible = !1;
		this.horizontal = !1;
		this.mobile_view = !1;
	...
	a.fn.ace_sidebar = function(d, e) {
		var f, g = this.each(function() {
			var b = a(this),
				...
				h = "object" == typeof d && d;
			g || b.data("ace_sidebar", g = new SideBar(this, h)), "string" == typeof d && "function" == typeof g[d] && (f = e instanceof Array ? g[d].apply(g, e) : g[d](e))
		});
		return f === b ? g : f
	};
...
(function(a, b) {
	function SideBarScroll(b, c) {
		...
		if (l) {
			...
			this.is_scrolling = !1;
			var v = !1;
			this.sidebar_fixed = ace.helper.getComputedStyle(b, "fixed");
			var w, x, y = function() {
	...
	a.fn.ace_sidebar_scroll || (a.fn.ace_sidebar_scroll = function(d, e) {
		var f, g = this.each(function() {
			var b = a(this),
				...
				h = "object" == typeof d && d;
			g || b.data("ace_sidebar_scroll", g = new SideBarScroll(this, h)),
...
(function(a, b) {
	function SideBarHover(b, c) {
		...
		var q = {},
			r = ace.vars.old_ie,
			s = !1;
		ace.vars.touch && (l.settings.sub_hover_delay = parseInt(Math.max(l.settings.sub_hover_delay, 2500)));
		var t = a(window),
			u = a(".navbar").eq(0),
		...
		var w = -1,e = ace.vars.old_ie || ace.vars.touch;
		...
		o.on(y, ".nav-list li, .sidebar-shortcuts", function() {
			if (q = o.ace_sidebar("vars"), !q.collapsible) {
				...
				var h = g,
					j = !1;
				if (h || this.parentNode != p || (h = b.find("> a > .menu-text").get(0)), !h && c && (h = b.find(".sidebar-shortcuts-large").get(0)), !(h && (j = ace.helper.getComputedStyle(h, "absolute")) || e)) return void(g && a(g).removeClass("can-scroll"));
				var m = i(this);
				if (g)
					if (j) {
						l.dirty = !0;
	...
	a.fn.ace_sidebar_hover = function(d, e) {
		var f, g = this.each(function() {
			var b = a(this),
				...
				h = "object" == typeof d && d;
			g || b.data("ace_sidebar_hover", g = new SideBarHover(this, h)), "string" == typeof d && "function" == typeof g[d] && (f = g[d](e))
		});
		return f === b ? g : f
	};
...
(function(a, b) {
	...
	a.fn.widget_box = function(c, e) {
		var f, g = this.each(function() {
			var b = a(this),
				g = b.data("widget_box"),
				h = "object" == typeof c && c;
			g || b.data("widget_box", g = new WidgetBox(this, h)), "string" == typeof c && (f = g[c](e))
		});
		return f === b ? g : f
	};
	//待改。。
	a(document).on("click.ace.widget", ".widget-header a[data-action]", function(b) {
		...
		if (0 != e.length && !e.hasClass("ui-sortable-helper")) {
			...
			f || e.data("widget_box", f = new WidgetBox(e.get(0)));
