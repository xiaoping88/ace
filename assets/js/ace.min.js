...
jQuery(function(a) {
	...
	var source = ["Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississippi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Dakota", "North Carolina", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming"];
	...
	jQuery(document).on("click", ".dropdown-navbar .nav-tabs", function(event) {
		...
		var c = jQuery(event.target).closest("[data-toggle=tab]");
		if (c.length > 0){
			c.tab("show");
	...
	jQuery(document).on("settings.ace.sidebar_scroll", function(b, c) {
		jQuery(".sidebar[data-sidebar-scroll=true]").each(function() {
			var b = jQuery(this),
	...
	jQuery(window).on("resize.ace.sidebar_scroll", function() {
		jQuery(".sidebar[data-sidebar-scroll=true]").each(function() {
			var b = jQuery(this);
			"true" == b.attr("data-sidebar-hover") && b.ace_sidebar_hover("reset");
			var c = jQuery(this).ace_sidebar_scroll("ref"),
				d = e(this, "fixed");
	...
	if (!ace.vars.very_old_ie) {
		jQuery(window).on("resize.sidebar.ace_hover", function() {
			jQuery(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("update_vars").ace_sidebar_hover("reset")
		});

		jQuery(document).on("settings.ace.ace_hover", function(b, c) {
			"sidebar_collapsed" == c ? jQuery(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("reset") : "navbar_fixed" == c && jQuery(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("update_vars")
		});
	}
